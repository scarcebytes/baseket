...
export default function HumanCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBasekets(initialValues.basekets);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const human = await DataStore.save(new Human(modelFieldsToSave));
          const promises = [];
          promises.push(
            ...basekets.reduce((promises, baseket) => {
              promises.push(
                DataStore.save(
                  new BaseketHuman({
                    human,
      ...
      {...getOverrideProps(overrides, "HumanCreateForm")}
      {...rest}
    >
      <TextField
        label="First name"
